...
export declare class Invocations extends APIResource {
     ...
     * ```
     */
    list(query?: InvocationListParams | null | undefined, options?: RequestOptions): PagePromise<InvocationListResponsesOffsetPagination, InvocationListResponse>;
    /**
     ...
     * ```
     */
    follow(id: string, query?: InvocationFollowParams | undefined, options?: RequestOptions): APIPromise<Stream<InvocationFollowResponse>>;
    /**
 ...
 */
export type InvocationFollowResponse = Shared.LogEvent | InvocationStateEvent | Shared.ErrorEvent | Shared.HeartbeatEvent;
export interface InvocationListBrowsersResponse {
    browsers: Array<InvocationListBrowsersResponse.Browser>;
}
export declare namespace InvocationListBrowsersResponse {
    interface Browser {
        /**
