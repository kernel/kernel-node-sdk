 ...
 */
export declare class Webmcp extends APIResource {
    /**
     ...
     * ```
     */
    invokeTool(idOrName: string, body: WebmcpInvokeToolParams, options?: RequestOptions): APIPromise<InvocationResult>;
    /**
