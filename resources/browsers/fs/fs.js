...
class Fs extends resource_1.APIResource {
    ...
    createDirectory(idOrName, body, options) {
        return this._client.put((0, path_1.path) `/browsers/${idOrName}/fs/create_directory`, {
            body,
            ...options,
    ...
    deleteDirectory(idOrName, body, options) {
        return this._client.put((0, path_1.path) `/browsers/${idOrName}/fs/delete_directory`, {
            body,
            ...options,
            headers: (0, headers_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]),
        });
    ...
    deleteFile(idOrName, body, options) {
        return this._client.put((0, path_1.path) `/browsers/${idOrName}/fs/delete_file`, {
            body,
            ...options,
            headers: (0, headers_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]),
        });
    ...
    downloadDirZip(idOrName, query, options) {
        return this._client.get((0, path_1.path) `/browsers/${idOrName}/fs/download_dir_zip`, {
            query,
            ...options,
    ...
    fileInfo(idOrName, query, options) {
        return this._client.get((0, path_1.path) `/browsers/${idOrName}/fs/file_info`, { query, ...options });
    }
    /**
    ...
    listFiles(idOrName, query, options) {
        return this._client.get((0, path_1.path) `/browsers/${idOrName}/fs/list_files`, { query, ...options });
    }
    /**
    ...
    move(idOrName, body, options) {
        return this._client.put((0, path_1.path) `/browsers/${idOrName}/fs/move`, {
            body,
            ...options,
            headers: (0, headers_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]),
        });
    ...
    readFile(idOrName, query, options) {
        return this._client.get((0, path_1.path) `/browsers/${idOrName}/fs/read_file`, {
            query,
            ...options,
    ...
    setFilePermissions(idOrName, body, options) {
        return this._client.put((0, path_1.path) `/browsers/${idOrName}/fs/set_file_permissions`, {
            body,
            ...options,
            headers: (0, headers_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]),
        });
    ...
    upload(idOrName, body, options) {
        return this._client.post((0, path_1.path) `/browsers/${idOrName}/fs/upload`, (0, uploads_1.multipartFormRequestOptions)({ body, ...options, headers: (0, headers_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]) }, this._client));
    }
    /**
    ...
    uploadZip(idOrName, body, options) {
        return this._client.post((0, path_1.path) `/browsers/${idOrName}/fs/upload_zip`, (0, uploads_1.multipartFormRequestOptions)({ body, ...options, headers: (0, headers_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]) }, this._client));
    }
    /**
    ...
    writeFile(idOrName, contents, params, options) {
        ...
        return this._client.put((0, path_1.path) `/browsers/${idOrName}/fs/write_file`, {
            body: contents,
