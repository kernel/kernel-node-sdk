...
export declare class Process extends APIResource {
     ...
     * ```
     */
    resize(processID: string, params: ProcessResizeParams, options?: RequestOptions): APIPromise<ProcessResizeResponse>;
    /**
     ...
     * ```
     */
    spawn(idOrName: string, body: ProcessSpawnParams, options?: RequestOptions): APIPromise<ProcessSpawnResponse>;
    /**
     * Get process status
     *
     * @example
...
export declare namespace Process {
    export { type ProcessExecResponse as ProcessExecResponse, type ProcessKillResponse as ProcessKillResponse, type ProcessResizeResponse as ProcessResizeResponse, type ProcessSpawnResponse as ProcessSpawnResponse, type ProcessStatusResponse as ProcessStatusResponse, type ProcessStdinResponse as ProcessStdinResponse, type ProcessStdoutStreamResponse as ProcessStdoutStreamResponse, type ProcessExecParams as ProcessExecParams, type ProcessKillParams as ProcessKillParams, type ProcessResizeParams as ProcessResizeParams, type ProcessSpawnParams as ProcessSpawnParams, type ProcessStatusParams as ProcessStatusParams, type ProcessStdinParams as ProcessStdinParams, type ProcessStdoutStreamParams as ProcessStdoutStreamParams, };
}
