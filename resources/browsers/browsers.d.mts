import type { RequestInfo } from "../../internal/builtin-types.mjs";
import { APIResource } from "../../core/resource.mjs";
import * as Shared from "../shared.mjs";
import * as ComputerAPI from "./computer.mjs";
import { Computer, ComputerBatchParams, ComputerCaptureScreenshotParams, ComputerClickMouseParams, ComputerDragMouseParams, ComputerGetMousePositionResponse, ComputerMoveMouseParams, ComputerPressKeyParams, ComputerReadClipboardResponse, ComputerScrollParams, ComputerSetCursorVisibilityParams, ComputerSetCursorVisibilityResponse, ComputerTypeTextParams, ComputerWriteClipboardParams } from "./computer.mjs";
import * as LogsAPI from "./logs.mjs";
import { LogStreamParams, Logs } from "./logs.mjs";
import * as PlaywrightAPI from "./playwright.mjs";
import { Playwright, PlaywrightExecuteParams, PlaywrightExecuteResponse } from "./playwright.mjs";
import * as ProcessAPI from "./process.mjs";
import { Process, ProcessExecParams, ProcessExecResponse, ProcessKillParams, ProcessKillResponse, ProcessResizeParams, ProcessResizeResponse, ProcessSpawnParams, ProcessSpawnResponse, ProcessStatusParams, ProcessStatusResponse, ProcessStdinParams, ProcessStdinResponse, ProcessStdoutStreamParams, ProcessStdoutStreamResponse } from "./process.mjs";
import * as ReplaysAPI from "./replays.mjs";
import { ReplayDownloadParams, ReplayListResponse, ReplayStartParams, ReplayStartResponse, ReplayStopParams, Replays } from "./replays.mjs";
import * as TelemetryAPI from "./telemetry.mjs";
import { BrowserAPICallEvent, BrowserCallStack, BrowserCaptchaChallengeResultEvent, BrowserCaptchaSolveResultEvent, BrowserCaptchaSolveStartedEvent, BrowserCdpCommandEvent, BrowserCdpCommandMethod, BrowserCdpConnectEvent, BrowserCdpDisconnectEvent, BrowserConsoleErrorEvent, BrowserConsoleLogEvent, BrowserEventContext, BrowserEventSource, BrowserHTTPHeaders, BrowserInteractionClickEvent, BrowserInteractionKeyEvent, BrowserInteractionScrollSettledEvent, BrowserLiveViewConnectEvent, BrowserLiveViewDisconnectEvent, BrowserMonitorDisconnectedEvent, BrowserMonitorInitFailedEvent, BrowserMonitorReconnectFailedEvent, BrowserMonitorReconnectedEvent, BrowserMonitorScreenshotEvent, BrowserNetworkIdleEvent, BrowserNetworkLoadingFailedEvent, BrowserNetworkRequestEvent, BrowserNetworkResponseEvent, BrowserPageCrashedEvent, BrowserPageDomContentLoadedEvent, BrowserPageLayoutSettledEvent, BrowserPageLayoutShiftEvent, BrowserPageLcpEvent, BrowserPageLoadEvent, BrowserPageNavigationEvent, BrowserPageNavigationSettledEvent, BrowserPageTabOpenedEvent, BrowserPlatformAPICallEvent, BrowserProxyErrorEvent, BrowserServiceCrashedEvent, BrowserSystemOomKillEvent, BrowserTelemetryCategoriesConfig, BrowserTelemetryCategoryConfig, BrowserTelemetryCdpControlConfig, BrowserTelemetryConfig, BrowserTelemetryControlConfig, BrowserTelemetryEvent, BrowserTelemetryExportConfig, BrowserTelemetryOtlpExportConfig, Telemetry as TelemetryAPITelemetry, TelemetryEventsParams, TelemetryEventsResponse, TelemetryEventsResponsesOffsetPagination, TelemetryStreamParams, TelemetryStreamResponse } from "./telemetry.mjs";
import * as WebmcpAPI from "./webmcp.mjs";
import { InvocationFailure, InvocationResult, InvokeRequest, Tool, ToolAnnotations, ToolFrame, ToolSource, ToolsResponse, Webmcp, WebmcpInvokeToolParams } from "./webmcp.mjs";
import * as FsAPI from "./fs/fs.mjs";
import { FCreateDirectoryParams, FDeleteDirectoryParams, FDeleteFileParams, FDownloadDirZipParams, FFileInfoParams, FFileInfoResponse, FListFilesParams, FListFilesResponse, FMoveParams, FReadFileParams, FSetFilePermissionsParams, FUploadParams, FUploadZipParams, FWriteFileParams, Fs } from "./fs/fs.mjs";
import { APIPromise } from "../../core/api-promise.mjs";
import { OffsetPagination, type OffsetPaginationParams, PagePromise } from "../../core/pagination.mjs";
import { type Uploadable } from "../../core/uploads.mjs";
import { RequestOptions } from "../../internal/request-options.mjs";
import { type BrowserFetchInit } from "../../lib/browser-fetch.mjs";
export declare class Browsers extends APIResource {
    ...
    logs: LogsAPI.Logs;
    computer: ComputerAPI.Computer;
    playwright: PlaywrightAPI.Playwright;
    webmcp: WebmcpAPI.Webmcp;
    /**
     ...
     * ```
     */
    retrieve(idOrName: string, query?: BrowserRetrieveParams | null | undefined, options?: RequestOptions): APIPromise<BrowserRetrieveResponse>;
    /**
     ...
     * ```
     */
    update(idOrName: string, body: BrowserUpdateParams, options?: RequestOptions): APIPromise<BrowserUpdateResponse>;
    /**
     ...
     * ```
     */
    list(query?: BrowserListParams | null | undefined, options?: RequestOptions): PagePromise<BrowserListResponsesOffsetPagination, BrowserListResponse>;
    /**
     ...
     * ```
     */
    loadExtensions(idOrName: string, body: BrowserLoadExtensionsParams, options?: RequestOptions): APIPromise<void>;
    /**
...
export declare namespace BrowserUpdateParams {
    /**
     * Telemetry configuration. Omit, set to null, or set to an empty object ({}) to
     * leave the existing configuration unchanged. Set enabled to true to enable
     * capture using VM defaults. Set enabled to false to stop capture. Provide browser
     ...
     * Viewport configuration to apply to the browser session.
     */
    interface Viewport extends Shared.BrowserViewport {
        /**
...
export declare namespace BrowserLoadExtensionsParams {
    interface Extension {
        /**
...
export declare namespace Browsers {
    ...
    export { Process as Process, type ProcessExecResponse as ProcessExecResponse, type ProcessKillResponse as ProcessKillResponse, type ProcessResizeResponse as ProcessResizeResponse, type ProcessSpawnResponse as ProcessSpawnResponse, type ProcessStatusResponse as ProcessStatusResponse, type ProcessStdinResponse as ProcessStdinResponse, type ProcessStdoutStreamResponse as ProcessStdoutStreamResponse, type ProcessExecParams as ProcessExecParams, type ProcessKillParams as ProcessKillParams, type ProcessResizeParams as ProcessResizeParams, type ProcessSpawnParams as ProcessSpawnParams, type ProcessStatusParams as ProcessStatusParams, type ProcessStdinParams as ProcessStdinParams, type ProcessStdoutStreamParams as ProcessStdoutStreamParams, };
    export { Logs as Logs, type LogStreamParams as LogStreamParams };
    export { Computer as Computer, type ComputerGetMousePositionResponse as ComputerGetMousePositionResponse, type ComputerReadClipboardResponse as ComputerReadClipboardResponse, type ComputerSetCursorVisibilityResponse as ComputerSetCursorVisibilityResponse, type ComputerBatchParams as ComputerBatchParams, type ComputerCaptureScreenshotParams as ComputerCaptureScreenshotParams, type ComputerClickMouseParams as ComputerClickMouseParams, type ComputerDragMouseParams as ComputerDragMouseParams, type ComputerMoveMouseParams as ComputerMoveMouseParams, type ComputerPressKeyParams as ComputerPressKeyParams, type ComputerScrollParams as ComputerScrollParams, type ComputerSetCursorVisibilityParams as ComputerSetCursorVisibilityParams, type ComputerTypeTextParams as ComputerTypeTextParams, type ComputerWriteClipboardParams as ComputerWriteClipboardParams, };
    export { Playwright as Playwright, type PlaywrightExecuteResponse as PlaywrightExecuteResponse, type PlaywrightExecuteParams as PlaywrightExecuteParams, };
    export { Webmcp as Webmcp, type InvocationFailure as InvocationFailure, type InvocationResult as InvocationResult, type InvokeRequest as InvokeRequest, type Tool as Tool, type ToolAnnotations as ToolAnnotations, type ToolFrame as ToolFrame, type ToolSource as ToolSource, type ToolsResponse as ToolsResponse, type WebmcpInvokeToolParams as WebmcpInvokeToolParams, };
}
