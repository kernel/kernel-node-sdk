...
export declare class Computer extends APIResource {
     ...
     * ```
     */
    captureScreenshot(idOrName: string, body?: ComputerCaptureScreenshotParams | null | undefined, options?: RequestOptions): APIPromise<Response>;
    /**
     ...
     * ```
     */
    setCursorVisibility(idOrName: string, body: ComputerSetCursorVisibilityParams, options?: RequestOptions): APIPromise<ComputerSetCursorVisibilityResponse>;
    /**
     ...
     * ```
     */
    writeClipboard(idOrName: string, body: ComputerWriteClipboardParams, options?: RequestOptions): APIPromise<void>;
}
...
export declare namespace ComputerBatchParams {
    /**
