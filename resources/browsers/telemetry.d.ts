...
export declare class Telemetry extends APIResource {
     ...
     * ```
     */
    events(idOrName: string, query?: TelemetryEventsParams | null | undefined, options?: RequestOptions): PagePromise<TelemetryEventsResponsesOffsetPagination, TelemetryEventsResponse>;
    /**
     ...
     * ```
     */
    stream(idOrName: string, params?: TelemetryStreamParams | undefined, options?: RequestOptions): APIPromise<Stream<TelemetryStreamResponse>>;
}
...
export declare namespace BrowserAPICallEvent {
    interface Data {
        /**
...
export declare namespace BrowserCaptchaChallengeResultEvent {
    /**
     * Per-challenge payload. This event is emitted once per challenge and determines
     * its overall outcome; captcha_solve_started and captcha_solve_result describe
     * individual tasks and may occur multiple times within the challenge.
    ...
    interface Data {
         ...
         */
        captcha_type: 'hcaptcha' | 'recaptcha_v2' | 'recaptcha_v3' | 'turnstile' | 'geetest' | 'press_and_hold' | 'other';
        /**
...
export declare namespace BrowserCaptchaSolveStartedEvent {
    /**
     * Per-task payload. A visible challenge may create multiple tasks. When present,
     * task_id correlates this event with a captcha_solve_result, while challenge_id
     * groups tasks from the same challenge. Events may arrive out of order or be
...
export declare namespace BrowserCdpDisconnectEvent {
    interface Data {
        /**
...
export declare namespace BrowserLiveViewConnectEvent {
    interface Data {
        /**
...
export declare namespace BrowserLiveViewDisconnectEvent {
    interface Data {
        /**
         * Wall-clock duration of the connection in milliseconds.
         */
...
export declare namespace BrowserProxyErrorEvent {
    /**
     * Browser event context stamped by the browser monitor onto all CDP-sourced
     * events. Identifies the target, frame, and navigation epoch in which the event
     * occurred.
    ...
    interface Data extends TelemetryAPI.BrowserEventContext {
         ...
         * values are dropped.
         */
        code: 'destination_blocked' | 'provider_blacklisted' | 'provider_unreachable' | 'provider_rejected' | 'origin_tls_timeout' | 'proxy_unavailable' | 'upstream_timeout' | 'upstream_dns_failure' | 'upstream_connect_failed';
        /**
...
export declare namespace BrowserServiceCrashedEvent {
    interface Data {
        /**
...
export declare namespace BrowserSystemOomKillEvent {
    interface Data {
        /**
