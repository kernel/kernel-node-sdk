...
import * as TelemetryAPI from "./browsers/telemetry.mjs";
...
export declare class BrowserPools extends APIResource {
     ...
     * ```
     */
    list(query?: BrowserPoolListParams | null | undefined, options?: RequestOptions): PagePromise<BrowserPoolsOffsetPagination, BrowserPool>;
    /**
...
export declare namespace BrowserPoolAcquireParams {
    /**
     * Telemetry override for the acquired browser, applied to this lease only. Merges
     * onto the browser's current (pool-inherited) telemetry using the same
     * per-category semantics as PATCH /browsers: provided categories override the
...
export declare namespace BrowserPools {
    export { type BrowserPool as BrowserPool, type BrowserPoolAcquireResponse as BrowserPoolAcquireResponse, type BrowserPoolsOffsetPagination as BrowserPoolsOffsetPagination, type BrowserPoolCreateParams as BrowserPoolCreateParams, type BrowserPoolUpdateParams as BrowserPoolUpdateParams, type BrowserPoolListParams as BrowserPoolListParams, type BrowserPoolDeleteParams as BrowserPoolDeleteParams, type BrowserPoolAcquireParams as BrowserPoolAcquireParams, type BrowserPoolReleaseParams as BrowserPoolReleaseParams, };
}
