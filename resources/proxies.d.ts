...
export interface ProxyUpdateResponse {
     ...
     * Configuration specific to the selected proxy `type`.
     */
    config?: ProxyUpdateResponse.DatacenterProxyConfig | ProxyUpdateResponse.IspProxyConfig | ProxyUpdateResponse.ResidentialProxyConfig | ProxyUpdateResponse.MobileProxyConfig | ProxyUpdateResponse.CustomProxyConfig;
    /**
     * IP address that the proxy uses when making requests.
     */
    ip_address?: string;
...
export declare namespace ProxyUpdateResponse {
    /**
     * Configuration for a datacenter proxy.
     */
    interface DatacenterProxyConfig {
