...
class Items extends resource_1.APIResource {
    ...
    retrieve(key, params, options) {
        ...
        return this._client.get((0, path_1.path) `/vaults/${id_or_name}/items/${key}`, { query, ...options });
    }
    /**
    ...
    update(key, params, options) {
        ...
        return this._client.patch((0, path_1.path) `/vaults/${id_or_name}/items/${key}`, { body, ...options });
    }
    /**
    ...
    list(idOrName, options) {
        return this._client.get((0, path_1.path) `/vaults/${idOrName}/items`, options);
    }
    /**
    ...
    delete(key, params, options) {
        ...
        return this._client.delete((0, path_1.path) `/vaults/${id_or_name}/items/${key}`, {
            ...options,
    ...
    events(key, params, options) {
        const { id_or_name, ...query } = params;
        return this._client.get((0, path_1.path) `/vaults/${id_or_name}/items/${key}/events`, { query, ...options });
    }
    /**
    ...
    performOperation(key, params, options) {
        const { id_or_name, ...body } = params;
        return this._client.post((0, path_1.path) `/vaults/${id_or_name}/items/${key}/operations`, {
            body,
            maxRetries: 0,
            ...options,
        });
    ...
    upsert(key, params, options) {
        const { id_or_name, ...body } = params;
        return this._client.put((0, path_1.path) `/vaults/${id_or_name}/items/${key}`, { body, ...options });
    }
}
exports.Items = Items;
